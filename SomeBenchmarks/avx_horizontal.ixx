...
#pragma region first_line
		...
		top[1] = _mm256_load_si256(reinterpret_cast<__m256i*>(y_ptr + WINDOW_SIZE));

		mid[0] = _mm256_load_si256(reinterpret_cast<__m256i*>(y_ptr + width));
		mid[1] = _mm256_load_si256(reinterpret_cast<__m256i*>(y_ptr + width + WINDOW_SIZE));
...
#pragma region last_line
		...
		low[1] = _mm256_load_si256(reinterpret_cast<__m256i*>(ptr + WINDOW_SIZE));

		mid[0] = _mm256_load_si256(reinterpret_cast<__m256i*>(ptr + width));
		mid[1] = _mm256_load_si256(reinterpret_cast<__m256i*>(ptr + width + WINDOW_SIZE));

		top[0] = _mm256_load_si256(reinterpret_cast<__m256i*>(ptr + 2 * width));
		top[1] = _mm256_load_si256(reinterpret_cast<__m256i*>(ptr + 2 * width + WINDOW_SIZE));
