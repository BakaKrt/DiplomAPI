...
export namespace SharedMemory {
    ...
    public:
        SharedMemoryObject(size_t size, size_t oneObjectSizeInBytes, wstring postfix = L"") {
            _settings = { size, oneObjectSizeInBytes, nullptr };
            _name = _SHARED_MEMORY_NAME + postfix + L"_" + to_wstring(_counter);
#ifdef LOG_SHARED_MEMORY
            wcout << L"CREATED " << _name << L"\n";
#endif // LOG_SHARED_MEMORY
            this->_counter++;
        }
        ...
        SharedMemoryMapSetting connect() noexcept {
        ...
        SharedMemoryMapSetting create() noexcept {
        ...
        wstring getName() const noexcept { return _name; }
